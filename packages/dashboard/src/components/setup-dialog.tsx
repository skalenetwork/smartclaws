  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <MessageBubble variant="primary">
        Install smartclaws-openclaw-plugin, then install the smartclaws onboarding skill and the
        role/device skills you need
      </MessageBubble>
      ...
      <MessageBubble variant="primary">Set up SmartClaws and create a new wallet</MessageBubble>
