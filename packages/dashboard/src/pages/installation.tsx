...
clawhub install smartclaws-device-novapm-sds011`}
                        ...
                        <p className="text-sm text-muted-foreground">
                            The plugin provides runtime tools. Skills are installed by slug and
                            contain the onboarding, role, and device-contract instructions your
                            OpenClaw agent follows.
                        </p>
                    </CardContent>
                </Card>
            )}
